public static class CapacityHelper
{
    public static string FormatCapacity(int adults, int children)
    {
        ...
        {
            throw new ArgumentOutOfRangeException(null, MessageResponse.RoomManagement.ROOM_TYPE_CAPACITY_INVALID);
        }
        if (adults == 0 && children == 0)
        {
            throw new ArgumentException(MessageResponse.RoomManagement.ROOM_TYPE_CAPACITY_INVALID);
        }
