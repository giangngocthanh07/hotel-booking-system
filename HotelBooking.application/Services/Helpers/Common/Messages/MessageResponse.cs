...
public static class MessageResponse
{
    ...
    public static class Validation
    {
        ...
        public const string SHORT_NAME = "Name is too short!";
        ...
        public const string EMPTY_ADDRESS = "Address must not be empty!";
    ...
    public static class RequestManagement
    {
        ...
        public static class HotelApproval
        {
            ...
            public const string HOTEL_REQUEST_CREATED_SUCCESS = "Hotel request created successfully!";
            public const string HOTEL_REQUEST_CREATE_FAILED = "Failed to create hotel request!";
            public const string HOTEL_REQUEST_NOT_FOUND = "Hotel request not found!";
            public const string HOTEL_REQUEST_UPDATED_SUCCESS = "Hotel request updated successfully!";
            public const string HOTEL_REQUEST_UPDATE_FAILED = "Failed to update hotel request!";
            ...
            public const string HOTEL_REGISTRATION_INVALID_LATITUDE = "Latitude must be between -90 and 90!";
            public const string HOTEL_REGISTRATION_INVALID_LONGITUDE = "Longitude must be between -180 and 180!";
            public const string HOTEL_REGISTRATION_EMPTY_TAX_CODE = "Tax code must not be empty!";
